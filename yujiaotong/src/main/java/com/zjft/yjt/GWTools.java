	...
	* 向指定URL发送GET方法的请求
	...
	public static String sendGet(String url, String param,String code) {
		...
		try {
			...
			log.info("GWTools获取GET联网请求编号[{}]，链接到【{}?{}】",start,url,param);
			// 打开和URL之间的连接
...
//			result = e.getMessage();
		...
		long time = (end-start);
		log.info("请求编号[{}]耗时[{}ms]得到反馈【{}】",start,time,result);
		return result;
	}
	/**
	 * 向指定URL发送POST方法的请求
	...
	public static String sendPost(String url, String param) {
		...
		String result = "";
		long start = System.currentTimeMillis();
		log.info("GWTools获取POST联网请求编号[{}]，链接到【{}?{}】",start,url,param);
		try {
...
//			Constants.
			...
			result="{\"resultcode\":\""+1+"\",\"resultmsg\":\"请求服务器超时,用时"+time+"秒！\"}";
		}
		...
		long end = System.currentTimeMillis();
		float time = (end-start)/1000;
		log.info("请求编号[{}]耗时[{}s]得到反馈【{}】",start,time,result);
		return result;
	}
	...
	public static String sendPostJson(String url ,String jsonstr,Map<String,String> headers){
		...
		String result = "";
		long start = System.currentTimeMillis();
		log.info("GWTools获取POST联网请求编号[{}]，链接到【{}?{}】",start,url,jsonstr);
		try {
			URL realUrl = new URL(url);
			// 打开和URL之间的连接
			HttpURLConnection conn = (HttpURLConnection)realUrl.openConnection();
